...
public class Menu {
    public static void menuMethod(String[][] gameBoard) {
        ...
        System.out.println(" Turn: "+Turns.turn+"    Balance:"+GameMap.gameplayCurrency+"     Nation Happiness: "+GameMap.nationHappiness);
        ...
        if(commandNumber==5){
            if(Building.isEvilPlanAvailable){
                if(GameMap.gameplayCurrency>10_000 && GameMap.tradingContractsEstablished==2
                    && GameMap.isKidnappingStarted && GameMap.isStealingStarted && GameMap.nationHappiness > 40) {
