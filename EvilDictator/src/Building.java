...
public class Building {
    ...
    public static void setBuildingStats(String buildingIcon, boolean isExpandedOnce, boolean isExpandedTwice,String[][] gameBoard, int row,int col, Building building) {
